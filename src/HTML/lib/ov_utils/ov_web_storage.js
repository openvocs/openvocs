...
export function set_session(app, url, client_id, user_id, session_id) {
    let id = app + "_" + url;
    console.log("set session", id, client_id, user_id, session_id);
...
/* based on https://www.sohamkamani.com/javascript/localstorage-with-ttl-expiry/ */
export function get_session(app, url) {
    let id = app + "_" + url;
