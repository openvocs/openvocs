/***
        ...
        ------------------------------------------------------------------------
*//**
        @file           ov_turn_attr_xor_relayed_address.h
        ...
        ------------------------------------------------------------------------
*/
#ifndef ov_turn_attr_xor_relayed_address_h
#define ov_turn_attr_xor_relayed_address_h

#define TURN_XOR_RELAYED_ADDRESS 0x0016
...
/**
        Check is an attribute buffer may contain a relayed address.
