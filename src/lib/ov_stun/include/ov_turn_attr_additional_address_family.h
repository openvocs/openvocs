/***
        ...
        ------------------------------------------------------------------------
*//**
        @file           ov_turn_attr_additional_address_family.h
        ...
        ------------------------------------------------------------------------
*/
#ifndef ov_turn_attr_additional_address_family_h
#define ov_turn_attr_additional_address_family_h

#define TURN_ADDITIONAL_ADDRESS_FAMILY 0x8000
...
size_t ov_turn_attr_additional_addr_family_encoding_length();
...
#endif /* ov_turn_attr_additional_address_family_h */
