/***
        ...
        ------------------------------------------------------------------------
*//**
        @file           ov_stun_xor_mapped_address.h
        ...
        @brief          Definition of RFC 5389 attribute "xor mapped address" 
        ...
        ------------------------------------------------------------------------
*/
#ifndef ov_stun_xor_mapped_address_h
#define ov_stun_xor_mapped_address_h
...
#endif /* ov_stun_xor_mapped_address_h */
