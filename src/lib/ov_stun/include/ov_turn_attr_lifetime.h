...
*//**
        ...
        ------------------------------------------------------------------------
*/
#ifndef ov_turn_attr_lifetime_h
#define ov_turn_attr_lifetime_h

#define TURN_LIFETIME 0x000D
...
size_t ov_turn_attr_lifetime_encoding_length();
