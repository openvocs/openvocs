...
int test_ov_stun_unknown_attributes_decode_pointer() {
  ...
  *(buffer + 4 + 5) = 0xCE;
  ...
  testrun(0 == ov_stun_unknown_attributes_decode_pointer(ov_list_get(list, 1)));
  testrun(0x1FF ==
          ov_stun_unknown_attributes_decode_pointer(ov_list_get(list, 2)));
  testrun(0xFACE ==
          ov_stun_unknown_attributes_decode_pointer(ov_list_get(list, 3)));
  testrun(6 == ov_stun_unknown_attributes_decode_pointer(ov_list_get(list, 4)));
  testrun(8 == ov_stun_unknown_attributes_decode_pointer(ov_list_get(list, 5)));
  list = ov_list_free(list);
...
int test_ov_stun_unknown_attributes_encode() {
  ...
  testrun(!ov_stun_unknown_attributes_encode(NULL, length, &next, unknown, 1));
  ...
  testrun(ov_stun_unknown_attributes_encode(buffer, length, NULL, unknown, 1));
  ...
  memset(buf, 0, length);
  testrun(ov_stun_unknown_attributes_encode(buffer, length, &next, unknown, 1));
  testrun(STUN_UNKNOWN_ATTRIBUTES ==
          ov_stun_attribute_get_type(buffer, length));
  testrun(2 == ov_stun_attribute_get_length(buffer, length));
  testrun(ntohs(*(uint16_t *)(buffer + 4)) == STUN_NONCE);
  ...
  testrun(ov_stun_unknown_attributes_encode(buffer, length, &next, unknown, 2));
  testrun(STUN_UNKNOWN_ATTRIBUTES ==
          ov_stun_attribute_get_type(buffer, length));
  ...
  testrun(ov_stun_unknown_attributes_encode(buffer, length, &next, unknown, 3));
  testrun(STUN_UNKNOWN_ATTRIBUTES ==
          ov_stun_attribute_get_type(buffer, length));
