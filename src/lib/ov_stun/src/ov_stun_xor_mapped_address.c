/***
        ...
        ------------------------------------------------------------------------
*//**
        @file           ov_stun_xor_mapped_address.c
        ...
        @brief          Implementation of RFC 5389 attribute "xor mapped address"


        ------------------------------------------------------------------------
*/
#include "../include/ov_stun_xor_mapped_address.h"
...
bool ov_stun_attribute_frame_is_xor_mapped_address(const uint8_t *buffer,
                                                   size_t length) {
...
size_t
ov_stun_xor_mapped_address_encoding_length(const struct sockaddr_storage *sa) {
...
bool ov_stun_xor_mapped_address_encode(uint8_t *buffer, size_t length,
  ...
  if (!ov_stun_attribute_set_type(buffer, length, STUN_XOR_MAPPED_ADDRESS))
    goto error;
...
bool ov_stun_xor_mapped_address_decode(const uint8_t *buffer, size_t length,
  ...
  if (!ov_stun_attribute_frame_is_xor_mapped_address(buffer, length))
    goto error;
