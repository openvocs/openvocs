...
int test_ov_stun_error_code_decode_phrase() {
  ...
  testrun(ov_stun_error_code_decode_phrase(attribute, 100, &phrase, &plength));
...
int test_ov_stun_error_code_encode() {
  ...
  testrun(!ov_stun_error_code_encode(attribute, size, NULL, 0, NULL, plength));
  ...
  testrun(
      !ov_stun_error_code_encode(attribute, size, NULL, 299, phrase, plength));
  testrun(
      !ov_stun_error_code_encode(attribute, size, NULL, 700, phrase, plength));
  ...
  plength = 3;
  testrun(
      ov_stun_error_code_encode(attribute, size, &next, 699, phrase, plength));
  testrun(STUN_ERROR_CODE == ov_stun_attribute_get_type(attribute, size));
...
int test_ov_stun_error_code_set_bad_request() {
  ...
  // size to small
  testrun(!ov_stun_error_code_set_bad_request(attribute, strlen(expect), NULL));
...
int test_ov_stun_error_code_set_stale_nonce() {
  ...
  // size to small
  testrun(!ov_stun_error_code_set_stale_nonce(attribute, strlen(expect), NULL));
...
int test_ov_stun_error_code_generate_response() {
  ...
  testrun(!ov_stun_error_code_generate_response(frame, 20, response, 20, NULL));
  ...
  testrun(0 ==
          memcmp(id, ov_stun_frame_get_transaction_id(response, len + 20), 12));
