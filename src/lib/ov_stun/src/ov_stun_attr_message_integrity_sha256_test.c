...
int test_ov_stun_add_message_integrity_sha256() {
  ...
  testrun(!ov_stun_add_message_integrity_sha256(NULL, 0, NULL, NULL, NULL, 0));

  testrun(!ov_stun_add_message_integrity_sha256(head, 100, ptr, NULL, key, 0));
  testrun(
  ...
  testrun(!ov_stun_add_message_integrity_sha256(head, 0, ptr, NULL, key, len));
  testrun(
      !ov_stun_add_message_integrity_sha256(NULL, 100, ptr, NULL, key, len));

  // < min
  testrun(!ov_stun_add_message_integrity_sha256(head, 55, ptr, NULL, key, len));

  memset(buffer, 0, 100);
  memset(expect, 0, 100);
  // min
  testrun(ov_stun_add_message_integrity_sha256(head, 56, ptr, NULL, key, len));
  ...
  ptr++;
  testrun(
      !ov_stun_add_message_integrity_sha256(head, length, ptr, NULL, key, len));
  ...
  testrun(ov_hmac(OV_HASH_SHA256, buffer, ptr - buffer, key, len, expect, &l1));
...
int test_ov_stun_check_message_integrity_sha256() {
  ...
  testrun(
      !ov_stun_check_message_integrity_sha256(NULL, 0, NULL, 0, NULL, 0, true));
  ...
  testrun(!ov_stun_check_message_integrity_sha256(head, length, arr, az, NULL,
                                                  len, true));
  testrun(!ov_stun_check_message_integrity_sha256(head, length, arr, az, key, 0,
                                                  true));
