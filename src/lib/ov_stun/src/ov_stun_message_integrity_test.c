...
int test_ov_stun_check_message_integrity() {
  ...
  testrun(
      !ov_stun_check_message_integrity(NULL, length, arr, az, key, len, true));
  testrun(!ov_stun_check_message_integrity(head, 0, arr, az, key, len, true));
  testrun(
      !ov_stun_check_message_integrity(head, length, NULL, az, key, len, true));
  testrun(
      !ov_stun_check_message_integrity(head, length, arr, 0, key, len, true));
  testrun(
      !ov_stun_check_message_integrity(head, length, arr, az, NULL, len, true));
  testrun(
  ...
  // different key
  testrun(!ov_stun_check_message_integrity(head, length, arr, az, key, len - 1,
                                           true));
  ...
  testrun(
      !ov_stun_check_message_integrity(head, length, arr, az, key, len, true));
  testrun(
      ov_stun_check_message_integrity(head, length, arr, az, key, len, false));
