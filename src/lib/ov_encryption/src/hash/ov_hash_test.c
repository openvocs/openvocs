...
int test_ov_hash_function_to_string() {
  ...
  expect = "unspec";
  testrun(0 == strncmp(ov_hash_function_to_string(0), expect, strlen(expect)));
...
int test_ov_hash_function_to_RFC8122_string() {
  ...
  expect = "sha-1";
  testrun(0 == strncmp(ov_hash_function_to_RFC8122_string(OV_HASH_SHA1), expect,
                       strlen(expect)));
  ...
  expect = "md5";
  testrun(0 == strncmp(ov_hash_function_to_RFC8122_string(OV_HASH_MD5), expect,
                       strlen(expect)));
