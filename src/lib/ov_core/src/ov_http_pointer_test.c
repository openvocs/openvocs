...
int test_ov_http_pointer_parse_version() {
  ...
  testrun(OV_HTTP_PARSER_ERROR == ov_http_pointer_parse_version(NULL, 0, NULL));
...
int test_ov_http_pointer_parse_status_line() {
  ...
  testrun(OV_HTTP_PARSER_ERROR ==
          ov_http_pointer_parse_status_line(NULL, len, &line, &version, NULL));
  testrun(OV_HTTP_PARSER_ERROR == ov_http_pointer_parse_status_line(
                                      (uint8_t *)buf, len, &line, NULL, NULL));
  testrun(OV_HTTP_PARSER_PROGRESS ==
          ov_http_pointer_parse_status_line((uint8_t *)buf, 0, &line, &version,
                                            NULL));
...
int test_ov_http_pointer_parse_request_line() {
  ...
  testrun(OV_HTTP_PARSER_ERROR ==
          ov_http_pointer_parse_request_line((uint8_t *)buf, len, NULL, NULL, 0,
                                             NULL));
  testrun(OV_HTTP_PARSER_ERROR ==
          ov_http_pointer_parse_request_line(NULL, len, &line, NULL, 0, NULL));
  testrun(OV_HTTP_PARSER_ERROR ==
          ov_http_pointer_parse_request_line((uint8_t *)buf, len, &line, NULL,
                                             0, NULL));
  testrun(OV_HTTP_PARSER_PROGRESS ==
          ov_http_pointer_parse_request_line((uint8_t *)buf, 0, &line, &version,
                                             0, NULL));
...
int test_ov_http_pointer_parse_header_line() {
  ...
  testrun(OV_HTTP_PARSER_PROGRESS ==
          ov_http_pointer_parse_header_line((uint8_t *)buf, 0, &line, 0, NULL));
  ...
  for (size_t i = 13; i < len; i++) {
    testrun(OV_HTTP_PARSER_SUCCESS == ov_http_pointer_parse_header_line(
                                          (uint8_t *)buf, i, &line, 0, NULL));
  }
...
int test_ov_http_message_create() {
  ...
  msg2 =
      ov_http_message_create((ov_http_message_config){.header.capacity = 100});
  testrun(msg2 != msg);
...
int check_parse_chunked() {
  ...
  testrun(ov_buffer_set(msg->buffer, string, strlen(string)));
  testrun(OV_HTTP_PARSER_SUCCESS == ov_http_pointer_parse_message(msg, &next));
...
int test_ov_http_message_shift_trailing_bytes() {
  ...
  // check dest
  testrun(OV_HTTP_PARSER_SUCCESS == ov_http_pointer_parse_message(dest, &next));
...
int test_ov_http_create_status() {
  ...
  testrun(
      !ov_http_create_status((ov_http_message_config){0}, (ov_http_version){0},
  ...
  // min valid input
  msg = ov_http_create_status((ov_http_message_config){0}, (ov_http_version){0},
                              (ov_http_status){.code = 100,
                                               .phrase.start = (uint8_t *)"x",
                                               .phrase.length = 1});

  testrun(msg);
  uint8_t *next = NULL;
  testrun(OV_HTTP_PARSER_SUCCESS == ov_http_pointer_parse_status_line(
...
int test_ov_http_create_request() {
  ...
  testrun(!ov_http_create_request((ov_http_message_config){0},
                                  (ov_http_version){0}, (ov_http_request){0}));
...
int test_ov_http_message_add_header() {
  ...
  testrun(0 == strncmp("GET / HTTP/1.1\r\nx:y\r\n", (char *)msg->buffer->start,
                       msg->buffer->length));
  testrun(OV_HTTP_PARSER_PROGRESS == ov_http_pointer_parse_message(msg, NULL));
...
int test_ov_http_pointer_parse_comma_list_item() {
  ...
  testrun(!ov_http_pointer_parse_comma_list_item(NULL, strlen(str), &out, &len,
                                                 &next));
  testrun(!ov_http_pointer_parse_comma_list_item((uint8_t *)str, 0, &out, &len,
                                                 &next));
...
int test_ov_http_pointer_find_item_in_comma_list() {
  ...
  testrun(
      !ov_http_pointer_find_item_in_comma_list(str, len, NULL, name_len, true));
  testrun(!ov_http_pointer_find_item_in_comma_list(str, len, name, 0, true));

  const uint8_t *out = NULL;
  out = ov_http_pointer_find_item_in_comma_list(str, len, name, name_len, true);
  testrun(out);
  testrun(out == str);

  out =
      ov_http_pointer_find_item_in_comma_list(str, len, name, name_len, false);
  testrun(out);
  testrun(out == str);

  testrun(!ov_http_pointer_find_item_in_comma_list(str, len, name, name_len - 1,
                                                   true));
  testrun(!ov_http_pointer_find_item_in_comma_list(str, len, name, name_len - 1,
                                                   false));
