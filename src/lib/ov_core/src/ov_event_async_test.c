...
int test_ov_event_async_store_free() {
  ...
  testrun(ov_event_async_set(
      store, "1", (ov_event_async_data){.socket = 1, .value = ov_json_object()},
      1000));

  testrun(ov_event_async_set(
      store, "2", (ov_event_async_data){.socket = 1, .value = ov_json_object()},
      1000));

  testrun(ov_event_async_set(
      store, "3", (ov_event_async_data){.socket = 1, .value = ov_json_object()},
      1000));
...
int test_ov_event_async_set() {
  ...
  ov_event_async_store *store =
      ov_event_async_store_create((ov_event_async_store_config){.loop = loop});
  ...
  ov_event_async_data data1 = (ov_event_async_data){.socket = 1, .value = val1};

  ov_event_async_data data2 = (ov_event_async_data){.socket = 2, .value = val2};

  ov_event_async_data data3 = (ov_event_async_data){.socket = 3, .value = val3};
...
int test_ov_event_async_unset() {
  ...
  testrun(ov_event_async_set(
      store, "2", (ov_event_async_data){.socket = 2, .value = ov_json_object()},
      1000));

  testrun(ov_event_async_set(
      store, "3", (ov_event_async_data){.socket = 3, .value = ov_json_object()},
      1000));
...
int check_timing() {
  ...
  ov_event_async_store *store = ov_event_async_store_create((
      ...
      .loop = loop, .invalidate_check_interval_usec = 20000, .cache = 100000});
...
int test_ov_event_async_drop() {
  ...
  ov_event_async_data data3 = (ov_event_async_data){.socket = 2, .value = val3};
