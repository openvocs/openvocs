...
static bool register_opcodes(ov_vm *vm) {
  ...
  return ov_vm_register(vm, OP_NEXT, "NEXT", next_handler, next_inv_handler) &&
         ov_vm_register(vm, OP_NEXT_2, "NEXT_2", next_2_handler,
                        next_2_inv_handler) &&
         ov_vm_register(vm, OP_WAIT, "WAIT", wait_handler, wait_inv_handler) &&
         ov_vm_register(vm, OP_ABORT, "ABORT", abort_handler, 0) &&
         ov_vm_register(vm, OP_NEXT_INV_ABORTS, "NEXT_INV_ABORTS", next_handler,
                        abort_handler) &&
...
static int test_ov_vm_register() {
  ...
  testrun(
      ov_vm_register(res.vm, 0x02, "OPCODE02", next_handler, next_inv_handler));
...
static int test_ov_vm_trigger() {
  ...
  testrun(handler_state_equals(next_state, 0, IGNORE, IGNORE, IGNORE, IGNORE, 0,
                               0));

  testrun(handler_state_equals(wait_state, 0, IGNORE, IGNORE, IGNORE, IGNORE, 0,
                               0));
  ...
  testrun(handler_state_equals(next_state, 1, OP_NEXT, 11, 12, 13, prog_id, 0));
  ...
  testrun(handler_state_equals(next_inv_state, 2, OP_NEXT, 11, 12, 13, prog_id,
                               &test_data));
  ...
  testrun(handler_state_equals(next_inv_state, 1, OP_NEXT, 14, 15, 16, prog_id,
                               &test_data));
...
static int test_ov_vm_continue() {
  ...
  testrun(handler_state_equals(wait_state, 1, OP_WAIT, 21, 22, 23, prog_id, 0));

  testrun(OV_EXEC_ERROR == ov_vm_continue(res.vm, "akureiri"));
  testrun(OV_EXEC_OK == ov_vm_continue(res.vm, prog_id));

  testrun(handler_state_equals(next_state, 2, OP_NEXT, 14, 15, 16, prog_id, 0));
...
static int test_ov_vm_abort() {
  ...
  testrun(
      handler_state_equals(next_2_state, 1, OP_NEXT_2, 21, 22, 23, prog_id, 0));

  testrun(handler_state_equals(wait_state, 1, OP_WAIT, 31, 32, 33, prog_id, 0));
  ...
  testrun(handler_state_equals(next_2_state, 0, IGNORE, IGNORE, IGNORE, IGNORE,
                               0, 0));
  ...
  testrun(
      handler_state_equals(next_inv_state, 2, OP_NEXT, 11, 12, 13, prog_id, 0));
  ...
  testrun(handler_state_equals(next_2_state, 1, OP_NEXT_2, 21, 22, 23, prog_id,
                               &test_data));
