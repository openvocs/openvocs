...
int test_ov_ice_proxy_generic_dtls_cookie_store_initialize() {
    ...
    for (size_t i = 1; i < 10; i++) {
        ...
        testrun(
            ov_ice_proxy_generic_dtls_cookie_store_initialize(store, i, 10));
...
int test_ov_ice_proxy_generic_dtls_cookie_generate() {
    ...
    testrun(1 == ov_ice_proxy_generic_dtls_cookie_verify(
                     ssl, cookie, strlen((char *)cookie)));
...
int test_ov_ice_proxy_generic_dtls_cookie_verify() {
    ...
    testrun(1 == ov_ice_proxy_generic_dtls_cookie_verify(
                     ssl, cookie, strlen((char *)cookie)));
    testrun(0 == ov_ice_proxy_generic_dtls_cookie_verify(
                     NULL, cookie, strlen((char *)cookie)));
    testrun(0 == ov_ice_proxy_generic_dtls_cookie_verify(
                     ssl, NULL, strlen((char *)cookie)));
