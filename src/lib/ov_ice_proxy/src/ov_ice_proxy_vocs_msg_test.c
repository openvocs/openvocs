...
int test_ov_ice_proxy_vocs_msg_client_response_from_ice_session_create() {
  ...
  testrun(!ov_ice_proxy_vocs_msg_client_response_from_ice_session_create(NULL,
                                                                         NULL));
  ...
  testrun(0 == strcmp("offer", ov_json_string_get(ov_json_get(
...
int test_ov_ice_proxy_vocs_msg_forward_stream() {
  ...
  testrun(0 == strcmp("127.0.0.1", ov_json_string_get(ov_json_get(
                                       par, "/" OV_KEY_STREAM "/" OV_KEY_SOCKET
                                            "/" OV_KEY_HOST))));
...
int test_ov_ice_proxy_vocs_msg_media() {
  ...
  ov_json_value *msg = ov_ice_proxy_vocs_msg_media("1", OV_MEDIA_OFFER, "sdp");
  testrun(msg);
