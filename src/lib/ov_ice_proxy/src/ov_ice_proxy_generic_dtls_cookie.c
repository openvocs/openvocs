/***
        ...
        ------------------------------------------------------------------------
*//**
        @file           ov_ice_proxy_generic_dtls_cookie.c
        @author         Markus
        ...
        ------------------------------------------------------------------------
*/
#include "../include/ov_ice_proxy_generic_dtls_cookie.h"
...
static ov_ice_proxy_generic_dtls_cookie_store *global_dtls_ice_cookie_store;

/*----------------------------------------------------------------------------*/

#define ov_ice_proxy_generic_dtls_COOKIE_STORE_MAGIC_BYTES 0xcc00
#define ov_ice_proxy_generic_dtls_COOKIE_STORE_THREAD_LOCK_TIMEOUT_USEC 100000
...
int ov_ice_proxy_generic_dtls_cookie_verify(SSL *ssl,
