...
int test_ov_mc_backend_sip_registry_create() {
  ...
  ov_mc_backend_sip_registry *reg =
...
int test_ov_mc_backend_sip_registry_register_call() {
  ...
  testrun(!ov_mc_backend_sip_registry_register_call(NULL, 0, NULL, NULL, NULL));
  testrun(!ov_mc_backend_sip_registry_register_call(reg, 0, NULL, NULL, NULL));
  testrun(!ov_mc_backend_sip_registry_register_call(NULL, 0, "1", NULL, NULL));
