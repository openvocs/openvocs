...
*//**
        ...
        ------------------------------------------------------------------------
*/
#ifndef ov_vocs_api_client_h
#define ov_vocs_api_client_h
...
typedef struct ov_vocs_api_client ov_vocs_api_client;

/*----------------------------------------------------------------------------*/

typedef struct ov_vocs_api_client_config {
