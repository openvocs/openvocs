/***
        ...
        ------------------------------------------------------------------------
*//**
        @file           ov_vocs_api_authentication.h
        ...
        ------------------------------------------------------------------------
*/
#ifndef ov_vocs_api_authentication_h
#define ov_vocs_api_authentication_h
...
typedef struct ov_vocs_api_authentication ov_vocs_api_authentication;

/*----------------------------------------------------------------------------*/

typedef struct ov_vocs_api_authentication_config {
...
} ov_vocs_api_authentication_config;
...
#endif /* ov_vocs_api_authentication_h */
