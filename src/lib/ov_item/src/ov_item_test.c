...
int check_pointer_replace_special_encoding() {
    ...
    testrun(!pointer_replace_special_encoding(
    ...
    memset(buffer2, '\0', size);
    testrun(
        pointer_replace_special_encoding(result, size, buffer1, "1", "x"));
    ...
    memset(buffer2, '\0', size);
    testrun(
        pointer_replace_special_encoding(result, size, buffer1, "g", "x"));
    ...
    memset(buffer2, '\0', size);
    testrun(
        pointer_replace_special_encoding(result, 10, buffer1, "~1", "/"));
    testrun(strlen(buffer2) == 10);
    testrun(strncmp("/123/abc/x", buffer2, strlen(buffer2)) == 0);

    memset(buffer2, '\0', size);
    testrun(
        pointer_replace_special_encoding(result, 4, buffer1, "~1", "/"));
    ...
    memset(buffer2, '\0', size);
    testrun(
        pointer_replace_special_encoding(result, 7, buffer1, "~1", "/"));
    testrun(strlen(buffer2) == 6);
    ...
    memset(buffer2, '\0', size);
    testrun(
        pointer_replace_special_encoding(result, 7, buffer1, "~0", "~"));
    testrun(strlen(buffer2) == 6);
    testrun(strncmp("12~abc", buffer2, strlen(buffer2)) == 0);
