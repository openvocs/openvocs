...
int test_ov_mc_interconnect_config_from_json() {
    ...
    ov_mc_interconnect_config config =
        ov_mc_interconnect_config_from_json(conf);
    ...
    testrun(0 == strcmp(config.dtls.cert,
...
int test_ov_mc_interconnect_unregister_session() {
    ...
    testrun(ov_mc_interconnect_unregister_session(
        self,
        (ov_socket_data){.host = "127.0.0.1", .port = 12345},
...
OV_TEST_RUN("ov_mc_interconnect",
            ...
            test_ov_mc_interconnect_create,
            test_ov_mc_interconnect_free,
