...
int test_ov_mc_interconnect_msg_connect_media() {
  ...
  testrun(0 == strcmp("name", ov_json_string_get(ov_json_get(
                                  out, "/" OV_KEY_PARAMETER "/" OV_KEY_NAME))));
  testrun(0 == strcmp("codec",
                      ov_json_string_get(ov_json_get(out, "/" OV_KEY_PARAMETER
                                                          "/" OV_KEY_CODEC))));
  testrun(0 == strcmp("host", ov_json_string_get(ov_json_get(
                                  out, "/" OV_KEY_PARAMETER "/" OV_KEY_HOST))));
...
int test_ov_mc_interconnect_msg_register() {
  ...
  testrun(0 == strcmp("name", ov_json_string_get(ov_json_get(
                                  out, "/" OV_KEY_PARAMETER "/" OV_KEY_NAME))));
  testrun(0 ==
          strcmp("pass", ov_json_string_get(ov_json_get(
