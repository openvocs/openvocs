...
static int test_ov_sip_message_response_create() {
  ...
  testrun(0 == ov_string_compare(reason, ov_sip_message_response_reason(msg)));
...
static bool find_compare_header(char const *header, char const *value,
  ...
  if ((0 == header) || (0 == value) || (0 == arg)) {
    ...
    arg->found_and_equals =
        (0 == ov_string_compare(value,
                                ov_sip_message_header(arg->other_msg, header)));
...
static int test_ov_sip_message_cseq_set() {
  ...
  testrun(0 == ov_string_compare(ov_sip_message_header(msg, OV_SIP_HEADER_CSEQ),
                                 "0 REGISTER"));
