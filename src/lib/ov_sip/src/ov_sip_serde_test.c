...
static int test_impl_add_raw() {
    ...
    testrun(0 ==
            ov_string_compare("OK-OK", ov_sip_message_response_reason(msg)));
...
static int test_ov_sip_message_to_string() {
    ...
    testrun(0 == ov_string_compare(str,
                                   "INVITE sip://censored.cpu " SIP_VERSION CRLF
                                   "Croak: "
                                   "456" CRLF OV_SIP_HEADER_CONTENT_LENGTH
                                   ": 0" CRLF "Blur: 123" CRLF CRLF));
    ...
    testrun(0 == ov_string_compare(
                     str,
                     "INVITE sip://censored.cpu " SIP_VERSION CRLF "Croak: "
...
static int test_impl_clear_buffer() {
    ...
    testrun(OV_SERDE_PROGRESS ==
            sip_serde_add(serde, "4321AchtundfuenzigUeber"));
