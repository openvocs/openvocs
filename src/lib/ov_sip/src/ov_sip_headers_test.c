...
static int test_ov_sip_headers_auth() {
  ...
  testrun(0 == ov_sip_headers_auth("sip:a.b", "7", 0, "realm", "REGISTER", 0));
  ...
  testrun(0 == ov_sip_headers_auth("sip:a.b", "7", "abc", "realm", 0, "nonce"));
  ...
  testrun(0 == ov_sip_headers_auth("sip:a.b", "7", 0, 0, "REGISTER", "nonce"));
  ...
  testrun(0 ==
          ov_sip_headers_auth("sip:a.b", "7", 0, "realm", "REGISTER", "nonce"));
  testrun(0 == ov_sip_headers_auth(0, 0, "abc", "realm", "REGISTER", "nonce"));
