...
int test_ov_codec_factory_create_standard() {
  ...
  codec = ov_codec_factory_get_codec(factory, ov_codec_pcm16_signed_id(), 0, 0);
  testrun(0 != codec);
...
int test_ov_codec_factory_install_codec() {
  ...
  testrun(0 == ov_codec_factory_install_codec(0, STRING, mockup_codec_create));
  ...
  testrun(0 ==
          ov_codec_factory_install_codec(factory, STRING, mockup_codec_create));
  ...
  testrun(mockup_2_codec_create == ov_codec_factory_install_codec(
...
int test_ov_codec_factory_get_codec() {
  ...
  ov_codec *c = ov_codec_factory_get_codec(factory, CODEC_NAME_1, 12, cparams);
  ...
  testrun(0 ==
          ov_codec_factory_install_codec(0, CODEC_NAME_1, mockup_codec_create));
