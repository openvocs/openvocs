...
static bool create_test_db(ov_vocs_db *db) {
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_LOOP, "loop11", OV_KEY_ROLES,
                                    out))
    goto error;
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_ROLE, "role31", OV_KEY_USERS,
                                    out))
    goto error;
...
int test_ov_vocs_db_update_entity_key() {
  ...
  testrun(3 == ov_json_object_count(ov_json_get(db->data.domains, "/domain")));
  ...
  testrun(ov_json_get(db->data.domains, "/domain/users"));
  testrun(1 == ov_json_object_count(db->data.domains));
  testrun(4 == ov_json_object_count(ov_json_get(db->data.domains, "/domain")));
  testrun(0 == ov_json_object_count(
                   ov_json_get(db->data.domains, "/domain/projects")));
  testrun(2 ==
          ov_json_object_count(ov_json_get(db->data.domains, "/domain/users")));
  testrun(0 == ov_dict_count(db->index.projects));
  ...
  testrun(ov_json_get(db->data.domains, "/domain/roles"));
  testrun(1 == ov_json_object_count(db->data.domains));
  testrun(5 == ov_json_object_count(ov_json_get(db->data.domains, "/domain")));
  testrun(0 == ov_json_object_count(
                   ov_json_get(db->data.domains, "/domain/projects")));
  testrun(2 ==
          ov_json_object_count(ov_json_get(db->data.domains, "/domain/users")));
  testrun(3 ==
          ov_json_object_count(ov_json_get(db->data.domains, "/domain/roles")));
  testrun(0 == ov_dict_count(db->index.projects));
  testrun(2 == ov_dict_count(db->index.users));
  testrun(3 == ov_dict_count(db->index.roles));
  testrun(0 == ov_dict_count(db->index.loops));
  ...
  testrun(ov_json_get(db->data.domains, "/domain/loops"));
  testrun(1 == ov_json_object_count(db->data.domains));
  testrun(6 == ov_json_object_count(ov_json_get(db->data.domains, "/domain")));
  testrun(0 == ov_json_object_count(
                   ov_json_get(db->data.domains, "/domain/projects")));
  testrun(2 ==
          ov_json_object_count(ov_json_get(db->data.domains, "/domain/users")));
  testrun(3 ==
          ov_json_object_count(ov_json_get(db->data.domains, "/domain/roles")));
  testrun(4 ==
          ov_json_object_count(ov_json_get(db->data.domains, "/domain/loops")));
  testrun(0 == ov_dict_count(db->index.projects));
  testrun(2 == ov_dict_count(db->index.users));
  testrun(3 == ov_dict_count(db->index.roles));
  ...
  testrun(ov_vocs_db_update_entity_key(db, OV_VOCS_DB_PROJECT, "project", "key",
                                       out));
  ...
  testrun(ov_json_get(db->data.domains, "/domain/users/user1/key/username/id"));
  ...
  testrun(ov_json_get(db->data.domains, "/domain/roles/role1/key/username/id"));
  ...
  testrun(ov_json_get(db->data.domains, "/domain/loops/loop1/key/username/id"));
...
int test_ov_vocs_db_delete_entity_key() {
  ...
  testrun(!ov_vocs_db_delete_entity_key(db, OV_VOCS_DB_USER, "unknown", "key"));
  ...
  testrun(
      !ov_vocs_db_delete_entity_key(db, OV_VOCS_DB_PROJECT, "project3", "id"));
...
int test_ov_vocs_db_delete_entity() {
  ...
  testrun(ov_json_get(db->data.domains, "/domain2"));
  testrun(3 == ov_json_object_count(ov_json_get(db->data.domains, "/domain1")));
  testrun(ov_json_get(db->data.domains, "/domain1/id"));
  testrun(ov_json_get(db->data.domains, "/domain1/projects"));
  testrun(3 == ov_json_object_count(ov_json_get(db->data.domains, "/domain2")));
  ...
  testrun(4 == ov_json_object_count(ov_json_get(db->data.domains,
                                                "/domain1/projects/project1")));
  ...
  testrun(
      ov_json_get(db->data.domains, "/domain1/projects/project1/users/user11"));
  testrun(
      ov_json_get(db->data.domains, "/domain1/projects/project1/users/user12"));
  testrun(
      ov_json_get(db->data.domains, "/domain1/projects/project1/roles/role11"));
  testrun(
      ov_json_get(db->data.domains, "/domain1/projects/project1/roles/role12"));
  testrun(
      ov_json_get(db->data.domains, "/domain1/projects/project1/loops/loop11"));
  testrun(
      ov_json_get(db->data.domains, "/domain1/projects/project1/loops/loop12"));
...
int test_ov_vocs_db_verify_entity_item() {
  ...
  testrun(
      ov_vocs_db_verify_entity_item(db, OV_VOCS_DB_USER, "unknown", out, &err));

  testrun(!err);

  testrun(
      ov_vocs_db_verify_entity_item(db, OV_VOCS_DB_USER, "user11", out, &err));
  ...
  testrun(
      ov_vocs_db_verify_entity_item(db, OV_VOCS_DB_USER, "role11", out, &err));
  ...
  testrun(
      ov_vocs_db_verify_entity_item(db, OV_VOCS_DB_LOOP, "unknown", out, &err));

  testrun(!err);

  testrun(
      ov_vocs_db_verify_entity_item(db, OV_VOCS_DB_LOOP, "loop11", out, &err));
  ...
  testrun(ov_vocs_db_verify_entity_item(db, OV_VOCS_DB_PROJECT, "unknown", out,
                                        &err));

  testrun(!err);

  testrun(ov_vocs_db_verify_entity_item(db, OV_VOCS_DB_PROJECT, "project1", out,
                                        &err));
...
int test_ov_vocs_db_update_entity_item() {
  ...
  testrun(
      ov_vocs_db_update_entity_item(db, OV_VOCS_DB_USER, "user11", out, &err));
  ...
  testrun(
      ov_vocs_db_update_entity_item(db, OV_VOCS_DB_ROLE, "role11", out, &err));
  ...
  testrun(
      ov_vocs_db_update_entity_item(db, OV_VOCS_DB_LOOP, "loop11", out, &err));
  ...
  testrun(!ov_vocs_db_update_entity_item(db, OV_VOCS_DB_DOMAIN, "domain1", out,
                                         &err));

  testrun(err);
  err = ov_json_value_free(err);

  testrun(!ov_vocs_db_update_entity_item(db, OV_VOCS_DB_DOMAIN, "domain3", out,
                                         &err));
  ...
  testrun(ov_vocs_db_update_entity_item(db, OV_VOCS_DB_PROJECT, "project3", out,
                                        &err));
...
int test_ov_vocs_db_get_permission() {
  ...
  testrun(OV_VOCS_NONE == ov_vocs_db_get_permission(NULL, "role12", "loop11"));
...
int test_ov_vocs_db_get_user_role_loops() {
  ...
  testrun(ov_vocs_db_set_state(db, "user11", "role11", "loop11", OV_VOCS_SEND));
  testrun(ov_vocs_db_set_state(db, "user11", "role21", "loop11", OV_VOCS_RECV));
...
int test_ov_vocs_db_set_state() {
  ...
  testrun(
      !ov_vocs_db_set_state(NULL, "user11", "role11", "loop11", OV_VOCS_NONE));
  ...
  testrun(ov_vocs_db_set_state(db, "user11", "role11", "loop11", OV_VOCS_NONE));
  testrun(ov_vocs_db_set_state(db, "user11", "role12", "loop11", OV_VOCS_RECV));
  testrun(ov_vocs_db_set_state(db, "user11", "role13", "loop11", OV_VOCS_SEND));
  testrun(ov_vocs_db_set_state(db, "user11", "role11", "loop12", OV_VOCS_SEND));
...
int test_ov_vocs_db_get_entity_domain() {
  ...
  testrun(out);
  testrun(0 == strcmp("domain1", ov_json_string_get(
                                     ov_json_object_get(out, OV_KEY_DOMAIN))));
  ...
  testrun(out);
  testrun(0 == strcmp("domain2", ov_json_string_get(
                                     ov_json_object_get(out, OV_KEY_DOMAIN))));
  ov_json_value_dump(stdout, out);
  out = ov_json_value_free(out);
...
int check_update_sip_permissions() {
  ...
  testrun(
      ov_vocs_db_update_entity_item(db, OV_VOCS_DB_LOOP, "loop11", loop, NULL));
  ...
  val =
      (ov_json_value *)ov_json_get(userdata.msg, "/parameter/processing/loop2");
  testrun(val);
