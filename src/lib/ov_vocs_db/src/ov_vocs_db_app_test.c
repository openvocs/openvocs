...
int test_ov_vocs_db_app_create() {
  ...
  ov_vocs_db_app *app =
      ov_vocs_db_app_create((ov_vocs_db_app_config){.loop = loop,
                                                    .db = db,
...
int check_authorize_connection_for_id() {
  ...
  testrun(ov_vocs_db_authorize_project_admin(db, "user2", "project@localhost"));
  testrun(ov_vocs_db_authorize_project_admin(db, "user1", "project@localhost"));

  // check autorization
  testrun(authorize_connection_for_id(app, 1, OV_VOCS_DB_DOMAIN, "localhost"));
  testrun(!authorize_connection_for_id(app, 2, OV_VOCS_DB_DOMAIN, "localhost"));

  testrun(authorize_connection_for_id(app, 1, OV_VOCS_DB_PROJECT,
                                      "project@localhost"));
  testrun(!authorize_connection_for_id(app, 2, OV_VOCS_DB_PROJECT,
                                       "project@localhost"));
  testrun(!authorize_connection_for_id(app, 3, OV_VOCS_DB_PROJECT,
                                       "project@localhost"));
...
int check_cb_event_login() {
  ...
  ov_event_parameter params =
      (ov_event_parameter){.send.instance = &userdata, .send.send = dummy_send};
...
int check_cb_event_get_admin_domains() {
  ...
  testrun(1 == userdata.socket);
  testrun(0 == ov_event_api_get_error_code(userdata.value));
  domains = ov_json_get(userdata.value, "/" OV_KEY_RESPONSE "/" OV_KEY_DOMAINS);
  testrun(domains);
...
static ov_json_value *msg_delete(const char *id, const char *type) {
  ...
  ov_json_value *out = ov_event_api_message_create(OV_VOCS_DB_DELETE, NULL, 0);
  ov_json_value *par = ov_event_api_set_parameter(out);
  ov_json_value *val = NULL;
...
static ov_json_value *msg_create(const char *id, const char *type,
                                 const char *scope_type, const char *scope_id) {

  ov_json_value *out = ov_event_api_message_create(OV_VOCS_DB_CREATE, NULL, 0);
  ov_json_value *par = ov_event_api_set_parameter(out);
  ov_json_value *val = NULL;
...
static ov_json_value *msg_get_key(const char *id, const char *type,
                                  const char *key) {

  ov_json_value *out = ov_event_api_message_create(OV_VOCS_DB_GET_KEY, NULL, 0);
  ov_json_value *par = ov_event_api_set_parameter(out);
  ov_json_value *val = NULL;
...
static ov_json_value *msg_update_key(const char *id, const char *type,
                                     const char *key, ov_json_value *data) {
...
static ov_json_value *msg_delete_key(const char *id, const char *type,
                                     const char *key) {
...
static ov_json_value *msg_verify(const char *id, const char *type,
                                 ov_json_value *data) {

  ov_json_value *out = ov_event_api_message_create(OV_VOCS_DB_VERIFY, NULL, 0);
  ov_json_value *par = ov_event_api_set_parameter(out);
  ov_json_value *val = NULL;
...
static ov_json_value *msg_update(const char *id, const char *type,
                                 ov_json_value *data) {

  ov_json_value *out = ov_event_api_message_create(OV_VOCS_DB_UPDATE, NULL, 0);
  ov_json_value *par = ov_event_api_set_parameter(out);
  ov_json_value *val = NULL;
...
int check_cb_event_add_project_admin() {
  ...
  testrun(ov_vocs_db_authorize_project_admin(db, "user3", "project@localhost"));
