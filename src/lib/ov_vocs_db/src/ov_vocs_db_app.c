...
static Connection *connection_create(ov_vocs_db_app *self, int socket,
...
static bool authorize_connection_for_id(ov_vocs_db_app *app, int socket,
  ...
  case OV_VOCS_DB_SCOPE_DOMAIN:
    ...
    if (!ov_vocs_db_authorize_domain_admin(app->config.db, user, parent.id)) {
      goto error;
    }
  ...
  case OV_VOCS_DB_SCOPE_PROJECT:
    ...
    if (!ov_vocs_db_authorize_project_admin(app->config.db, user, parent.id)) {
      goto error;
    }
...
static void cb_ldap_authentication(void *userdata, const char *uuid,
  ...
  case OV_LDAP_AUTH_REJECTED:
    ...
    ov_log_error("LDAP AUTHENTICATE failed at %i | %s", data.socket, user);

    out = ov_event_api_create_error_response(data.value, OV_ERROR_CODE_AUTH,
                                             OV_ERROR_DESC_AUTH);
  ...
  if (!ov_vocs_json_set_id(res, user))
    goto error;
  if (!ov_vocs_json_set_session_id(res, session_id))
    goto error;
  ...
  if (!ov_broadcast_registry_set(self->broadcasts,
                                 OV_BROADCAST_KEY_SYSTEM_BROADCAST, data.socket,
                                 OV_SYSTEM_BROADCAST)) {
    goto error;
  }
...
static bool cb_event_login(void *userdata, const int socket,
  ...
  if (app->config.ldap.enable) {
    ...
    return ov_ldap_authenticate_password(
        app->ldap, user, pass, uuid,
        (ov_ldap_auth_callback){.userdata = app,
...
static bool cb_update_client_login(void *userdata, const int socket,
                                   const ov_event_parameter *params,
                                   ov_json_value *input) {
  ...
  if (!ov_event_session_update(app->user_sessions, client_id, user_id,
                               session_id)) {
  ...
  out = ov_event_api_create_success_response(input);
  ov_json_value *res = ov_event_api_get_response(out);
  if (!ov_vocs_json_set_id(res, user_id))
    goto error;
  if (!ov_vocs_json_set_session_id(res, session_id))
    goto error;
...
static bool cb_event_logout(void *userdata, const int socket,
                            const ov_event_parameter *params,
                            ov_json_value *input) {
...
static bool cb_event_update_password(void *userdata, const int socket,
                                     const ov_event_parameter *params,
                                     ov_json_value *input) {
  ...
  if (0 == ov_string_compare(user, conn_user)) {
    ...
    case OV_VOCS_DB_SCOPE_DOMAIN:
      ...
      if (!ov_vocs_db_authorize_domain_admin(app->config.db, conn_user,
                                             parent.id)) {
    ...
    case OV_VOCS_DB_SCOPE_PROJECT:
      ...
      if (!ov_vocs_db_authorize_project_admin(app->config.db, conn_user,
                                              parent.id)) {
...
static bool cb_event_get_admin_domains(void *userdata, const int socket,
                                       const ov_event_parameter *params,
                                       ov_json_value *input) {
...
static bool cb_event_get_admin_projects(void *userdata, const int socket,
                                        const ov_event_parameter *params,
                                        ov_json_value *input) {
...
static bool cb_event_check_id_exists(void *userdata, const int socket,
                                     const ov_event_parameter *params,
                                     ov_json_value *input) {
...
static bool cb_event_get(void *userdata, const int socket,
                         const ov_event_parameter *params,
                         ov_json_value *input) {
...
static bool cb_event_delete(void *userdata, const int socket,
                            const ov_event_parameter *params,
                            ov_json_value *input) {
...
static bool cb_event_create(void *userdata, const int socket,
                            const ov_event_parameter *params,
                            ov_json_value *input) {
 ...
 */
  ...
  const char *scope_id = ov_json_string_get(
      ov_json_get(input, "/" OV_KEY_PARAMETER "/" OV_KEY_SCOPE "/" OV_KEY_ID));
  ...
  if (0 == strcmp(scope_type, OV_KEY_DOMAIN)) {
    ...
    if (!ov_vocs_db_authorize_domain_admin(app->config.db, user, scope_id)) {
  ...
  } else if (!ov_vocs_db_authorize_project_admin(app->config.db, user,
                                                 scope_id)) {
  ...
  if (!ov_vocs_db_create_entity(app->config.db, entity, id, db_scope,
                                scope_id)) {
...
static bool cb_event_get_key(void *userdata, const int socket,
                             const ov_event_parameter *params,
                             ov_json_value *input) {
 ...
 */
  ...
  if (!ov_json_object_set(res, OV_KEY_ID, val))
    goto error;

  val = ov_json_string(key);
  if (!ov_json_object_set(res, OV_KEY_KEY, val))
    goto error;
...
static bool cb_event_update_key(void *userdata, const int socket,
                                const ov_event_parameter *params,
                                ov_json_value *input) {
...
static bool cb_event_delete_key(void *userdata, const int socket,
                                const ov_event_parameter *params,
                                ov_json_value *input) {
...
static bool cb_event_verify(void *userdata, const int socket,
                            const ov_event_parameter *params,
                            ov_json_value *input) {
 ...
 */
  ...
  if (!ov_vocs_db_verify_entity_item(app->config.db, entity, id, data,
                                     &errors)) {
...
static bool cb_event_update(void *userdata, const int socket,
                            const ov_event_parameter *params,
                            ov_json_value *input) {
 ...
 */
  ...
  if (!ov_vocs_db_update_entity_item(app->config.db, entity, id, data,
                                     &errors)) {
...
static bool cb_event_load(void *userdata, const int socket,
                          const ov_event_parameter *params,
                          ov_json_value *input) {
...
static bool cb_event_save(void *userdata, const int socket,
                          const ov_event_parameter *params,
                          ov_json_value *input) {
...
static bool cb_event_set_layout(void *userdata, const int socket,
                                const ov_event_parameter *params,
                                ov_json_value *input) {
...
static bool cb_event_get_layout(void *userdata, const int socket,
                                const ov_event_parameter *params,
                                ov_json_value *input) {
...
static bool cb_event_add_domain_admin(void *userdata, const int socket,
                                      const ov_event_parameter *params,
                                      ov_json_value *input) {
...
static bool cb_event_add_project_admin(void *userdata, const int socket,
                                       const ov_event_parameter *params,
                                       ov_json_value *input) {
...
static bool cb_event_ldap_import(void *userdata, const int socket,
                                 const ov_event_parameter *params,
                                 ov_json_value *input) {
...
static bool cb_event_set_keyset_layout(void *userdata, const int socket,
                                       const ov_event_parameter *params,
                                       ov_json_value *input) {
...
static bool cb_event_get_keyset_layout(void *userdata, const int socket,
                                       const ov_event_parameter *params,
                                       ov_json_value *input) {
...
static bool cb_event_set_user_data(void *userdata, const int socket,
                                   const ov_event_parameter *params,
                                   ov_json_value *input) {
...
static bool cb_event_get_user_data(void *userdata, const int socket,
                                   const ov_event_parameter *params,
                                   ov_json_value *input) {
...
static bool cb_event_get_highest_port(void *userdata, const int socket,
                                      const ov_event_parameter *params,
                                      ov_json_value *input) {
...
bool register_event_callbacks(ov_vocs_db_app *self) {
  ...
  if (!ov_event_engine_register(self->engine, OV_EVENT_API_LOGIN,
                                cb_event_login))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_EVENT_API_UPDATE_LOGIN,
                                cb_update_client_login))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_EVENT_API_AUTHENTICATE,
                                cb_event_login))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_EVENT_API_LOGOUT,
                                cb_event_logout))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_UPDATE_PASSWORD,
                                cb_event_update_password))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_ADMIN_DOMAINS,
                                cb_event_get_admin_domains))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_ADMIN_PROJECTS,
                                cb_event_get_admin_projects))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_ID_EXISTS,
                                cb_event_check_id_exists))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_GET, cb_event_get))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_DELETE,
                                cb_event_delete))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_CREATE,
                                cb_event_create))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_GET_KEY,
                                cb_event_get_key))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_UPDATE_KEY,
                                cb_event_update_key))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_DELETE_KEY,
                                cb_event_delete_key))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_VERIFY,
                                cb_event_verify))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_UPDATE,
                                cb_event_update))
    goto error;
  ...
  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_SET_LAYOUT,
                                cb_event_set_layout))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_GET_LAYOUT,
                                cb_event_get_layout))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_ADD_DOMAIN_ADMIN,
                                cb_event_add_domain_admin))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_ADD_PROJECT_ADMIN,
                                cb_event_add_project_admin))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_LDAP_IMPORT,
                                cb_event_ldap_import))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_SET_KEYSET_LAYOUT,
                                cb_event_set_keyset_layout))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_GET_KEYSET_LAYOUT,
                                cb_event_get_keyset_layout))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_SET_USER_DATA,
                                cb_event_set_user_data))
    goto error;

  if (!ov_event_engine_register(self->engine, OV_VOCS_DB_GET_USER_DATA,
                                cb_event_get_user_data))
    goto error;

  if (!ov_event_engine_register(self->engine, "get_highest_port",
                                cb_event_get_highest_port))
    goto error;
...
ov_vocs_db_app *ov_vocs_db_app_create(ov_vocs_db_app_config config) {
  ...
  if (!self->async || !self->connections)
    goto error;

  if (self->config.ldap.enable && !module_load_ldap(self))
    goto error;

  if (!register_event_callbacks(self))
    goto error;
...
ov_vocs_db_app *ov_vocs_db_app_cast(const void *data) {
  ...
  if (*(uint16_t *)data != OV_VOCS_DB_APP_MAGIC_BYTES)
    return NULL;
...
ov_vocs_db_app_config_from_json(const ov_json_value *val) {
...
static bool env_send(ov_vocs_db_app *app, int socket,
  ...
  bool result = app->config.env.send(app->config.env.userdata, socket, input);
...
static bool send_socket(void *userdata, int socket,
                        const ov_json_value *input) {
