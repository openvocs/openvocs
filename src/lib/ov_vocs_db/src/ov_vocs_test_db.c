...
static bool create_test_db(ov_vocs_db *db) {
  ...
  if (!ov_vocs_db_create_entity(db, OV_VOCS_DB_LOOP, "loop1",
                                OV_VOCS_DB_SCOPE_PROJECT, "project@localhost"))
    goto error;
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_ROLE, "role1", OV_KEY_USERS,
                                    out))
    goto error;
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_ROLE, "role2", OV_KEY_USERS,
                                    out))
    goto error;
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_ROLE, "role3", OV_KEY_USERS,
                                    out))
    goto error;
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_LOOP, "loop1", OV_KEY_ROLES,
                                    out))
    goto error;
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_LOOP, "loop2", OV_KEY_ROLES,
                                    out))
    goto error;
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_LOOP, "loop3", OV_KEY_ROLES,
                                    out))
    goto error;
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_LOOP, "loop4", OV_KEY_ROLES,
                                    out))
    goto error;
  ...
  if (!ov_vocs_db_update_entity_key(db, OV_VOCS_DB_LOOP, "loop5", OV_KEY_ROLES,
                                    out))
    goto error;
