...
ov_item *ov_item_object() {
    ...
    ov_item *item = item_create((ov_item_config){.literal = OV_ITEM_OBJECT});
...
bool ov_item_object_for_each(ov_item *self,
    ...
    bool result =
        ov_dict_for_each(self->config.data, userdata, (void *)function);
...
ov_item *ov_item_array() {
    ...
    ov_item *item = item_create((ov_item_config){.literal = OV_ITEM_ARRAY});
...
ov_item *ov_item_string(const char *string) {
    ...
    ov_item *item = item_create((ov_item_config){.literal = OV_ITEM_STRING});
...
ov_item *ov_item_number(double number) {
    ...
    ov_item *item = item_create((ov_item_config){.literal = OV_ITEM_NUMBER});
...
ov_item *ov_item_null() {
    ...
    ov_item *item = item_create((ov_item_config){.literal = OV_ITEM_NULL});
...
ov_item *ov_item_true() {
    ...
    ov_item *item = item_create((ov_item_config){.literal = OV_ITEM_TRUE});
...
ov_item *ov_item_false() {
    ...
    ov_item *item = item_create((ov_item_config){.literal = OV_ITEM_FALSE});
