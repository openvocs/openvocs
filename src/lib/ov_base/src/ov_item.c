...
static ov_item *object_get_with_length(ov_item *object,
                                                  const char *key,
                                                  size_t length) {
...
static bool pointer_parse_token(const char *start,
                                     size_t size,
                                     char **token,
                                     size_t *length) {
...
static bool pointer_replace_special_encoding(char *result,
                                                  size_t size,
                                                  char *source,
                                                  char *to_replace,
                                                  char *replacement) {
...
static bool pointer_escape_token(char *start,
                                      size_t size,
                                      char *token,
                                      size_t length) {
    ...
    if (!pointer_replace_special_encoding(
...
static ov_item *pointer_get_token_in_parent(ov_item *parent,
                                                       char *token,
                                                       size_t length) {
