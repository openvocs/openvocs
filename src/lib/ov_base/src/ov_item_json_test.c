...
int check_parser_calculate_value() {
    ...
    ov_item_json_stringify_config conf_minimal = ov_item_json_config_stringify_minimal();
    ov_item_json_stringify_config conf_default = ov_item_json_config_stringify_default();

    expect = "{}";

    testrun(strlen(expect) ==
            (size_t)parser_calculate(value, &conf_minimal));
    testrun(strlen(expect) ==
            (size_t)parser_calculate(value, &conf_default));
...
int test_ov_item_to_json_with_config() {
    ...
    char *string = ov_item_to_json_with_config(item, 
