...
static int test_ov_time_to_string() {
  ...
  testrun(ov_time_to_string(tstr, sizeof(tstr), 1000 * 1000 * ref_epoch, USEC));
...
static int test_ov_timestamp_parse() {
  ...
  testrun(!ov_timestamp_parse("2022-05-05T17:18:26", &y, &mo, &d, &h, &m, &s));
  testrun(!ov_timestamp_parse("2022-05-05T17:18:26z", &y, &mo, &d, &h, &m, &s));
  testrun(!ov_timestamp_parse("2022-05-05T17-18-26Z", &y, &mo, &d, &h, &m, &s));
  testrun(!ov_timestamp_parse("2022-05-05T17:18:2Z", &y, &mo, &d, &h, &m, &s));
  testrun(!ov_timestamp_parse("2022-05-05T17:1:26Z", &y, &mo, &d, &h, &m, &s));
  testrun(!ov_timestamp_parse("2022-05-05T1:18:26Z", &y, &mo, &d, &h, &m, &s));
  testrun(!ov_timestamp_parse("2022-05-5T17:18:26Z", &y, &mo, &d, &h, &m, &s));
  testrun(!ov_timestamp_parse("2022-5-05T17:18:26Z", &y, &mo, &d, &h, &m, &s));
  testrun(!ov_timestamp_parse("202-05-05T17:18:26Z", &y, &mo, &d, &h, &m, &s));
