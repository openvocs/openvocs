...
int test_ov_sdp_parse() {
    ...
    testrun(0 ==
            strncmp(session->description->connection->addrtype, "type", 4));
    ...
    str = "IP4";
    testrun(0 ==
            strncmp(session->origin.connection.addrtype, str, strlen(str)));
    str = "0.0.0.0";
...
int test_ov_sdp_stringify() {
    ...
    connection = calloc(1, sizeof(ov_sdp_connection));
    testrun(connection);
    testrun(ov_node_push((void **)&session->description->connection,
                         connection)) connection->nettype = "1";
    connection->addrtype = "2";
    connection->address = "3";
    ...
    testrun(connection);
    testrun(ov_node_push((void **)&session->description->connection,
                         connection)) connection->nettype = "4";
    connection->addrtype = "5";
    connection->address = "6";
...
int test_ov_sdp_session_persist() {
    ...
    testrun(0 ==
            strncmp((char *)sess->buffer->start + offset, "clear:text", 10));
