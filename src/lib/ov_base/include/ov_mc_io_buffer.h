...
*//**
        ...
        ------------------------------------------------------------------------
*/
#ifndef ov_mc_io_buffer_h
#define ov_mc_io_buffer_h
...
typedef struct ov_mc_io_buffer ov_mc_io_buffer;

/*----------------------------------------------------------------------------*/

typedef struct ov_mc_io_buffer_config {
    ...
    struct {
        ...
        void *userdata;
        void (*success)(void *userdata, ov_socket_data remote, ov_json_value *value);
        void (*failure)(void *userdata, ov_socket_data remote);

    } callback;

} ov_mc_io_buffer_config;
...
ov_mc_io_buffer *ov_mc_io_buffer_cast(const void *self);
