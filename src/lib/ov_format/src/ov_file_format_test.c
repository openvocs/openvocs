...
int test_ov_file_format_register() {
  ...
  testrun(handlers_in_format_registry(reg->format_handler, format_types_present,
                                      2));
...
static void *thread_test_get_desc(void *arg) {
  ...
  while (current < container->stop_time) {
    ...
    ov_file_format_desc format =
        ov_file_format_get_desc(container->registry, container->files[random]);
    /*
            fprintf(
                stdout, "%li - %i|%s\n", (long)id, random,
...
int test_ov_file_format_register_values_to_json() {
  ...
  testrun(!ov_file_format_register_values_to_json((ov_file_format_parameter){0},
                                                  0, NULL));
  ...
  out = ov_file_format_register_values_to_json((ov_file_format_parameter){0}, 1,
                                               (char const *[]){"1"});
  ...
  testrun(1 == ov_json_array_count(arr))
      testrun(0 == strcmp("1", ov_json_string_get(ov_json_array_get(arr, 1))));
  out = ov_json_value_free(out);

  out = ov_file_format_register_values_to_json((ov_file_format_parameter){0}, 3,
                                               (char const *[]){"1", "2", "3"});
...
int test_ov_file_format_register_values_from_json() {
  ...
  testrun(
      !ov_file_format_register_values_from_json(NULL, NULL, NULL, NULL, NULL));
  testrun(!ov_file_format_register_values_from_json(NULL, NULL, &para, &p_size,
                                                    array));
  testrun(!ov_file_format_register_values_from_json(val, NULL, NULL, &p_size,
                                                    array));
  testrun(
      !ov_file_format_register_values_from_json(val, NULL, &para, NULL, array));
  ...
  testrun(!ov_file_format_register_values_from_json(obj, "other_name", &para,
                                                    &p_size, array));
  testrun(ov_file_format_register_values_from_json(obj, "name", &para, &p_size,
                                                   array));
  testrun(p_size == 3);
  testrun(0 == strcmp(array[0], "1"));
  testrun(0 == strcmp(array[1], "2"));
  ...
  testrun(!ov_file_format_register_values_from_json(val, "name", &para, &p_size,
                                                    array));
  testrun(!ov_file_format_register_values_from_json(obj, "name", &para, &p_size,
                                                    array));
  ...
  testrun(0 == ov_json_array_count(ov_json_object_get(val, OV_KEY_EXTENSION)));
...
int test_ov_file_format_register_from_json_from_path() {
  ...
  for (size_t i = 0; i < items - 1; i++) {
    ...
    testrun(OV_FILE_SUCCESS == ov_file_write(files[i], (uint8_t *)content[i],
                                             strlen(content[i]), "w"));
  }
