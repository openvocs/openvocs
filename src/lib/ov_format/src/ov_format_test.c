...
static int test_ov_format_from_memory() {
    ...
    ov_format *stacked_tier_1 =
        ov_format_wrap(fmt, "dummy1", &dummy_handler, 0);
...
static int test_ov_format_get_memory() {
    ...
    ov_format *fmt =
        ov_format_from_memory((uint8_t *)ref_data, ref_len, OV_READ);
...
static int test_ov_format_close() {
    ...
    ov_format *check_called_fmt =
        ov_format_wrap(mem, "dummy", &dummy_handler, 0);
...
static int test_ov_format_has_more_data() {
    ...
    while (ov_format_has_more_data(interrupting_format)) {
        ...
        ov_buffer buf =
            ov_format_payload_read_chunk_nocopy(interrupting_format, 1);
...
static int test_ov_format_payload_overwrite() {
    ...
    ov_format *stacked_fmt =
        ov_format_wrap(mem_fmt, "dummy", &dummy_handler, 0);
    ...
    testrun(overwrite_data.length == (size_t)ov_format_payload_overwrite(
                                         stacked_fmt, 0, &overwrite_data));
...
static int test_ov_format_buffered_update() {
    ...
    testrun(
        !ov_format_buffered_update(0, (uint8_t *)ref_data, strlen(ref_data)));
