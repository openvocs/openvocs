...
int test_impl_write_chunk() {
  ...
  char const *chunk3 = "Die Sonne von Süden,   des Mondes Gesellin,\n"
                       "\n"
...
int test_crc_ogg() {
  ...
  fprintf(stderr,
          ...
          original_checksum, correct_checksum,
...
OV_TEST_RUN("ov_format_ogg", test_ov_format_ogg_install, test_impl_write_chunk,
            test_crc_ogg, test_impl_next_chunk, test_ov_format_ogg_new_stream,
            test_ov_format_ogg_select_stream, tear_down);
